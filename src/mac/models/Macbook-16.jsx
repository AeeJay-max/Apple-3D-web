...
Files: macbook-16.glb [639.28KB] > C:\Users\taten\OneDrive\Desktop\Big ones\Apple 3d\frontend\public\assets\mac_Assets\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacBookModel16(props) {
  ...
  const { nodes, materials, scene } = useGLTF('/assets/mac_Assets/models/macbook-16-transformed.glb')
...
useGLTF.preload('/assets/mac_Assets/models/macbook-16-transformed.glb')
